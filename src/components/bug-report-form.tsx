...
export const DEFAULT_BUG_REPORT_COPY: BugReportCopy = {
  ...
  messagePlaceholder: "What happened? Take your time. Tell us what went wrong.",
  messageError: "Tell us a little about what you saw first.",
  nameLabel: "Name",
  namePlaceholder: "Your name",
  emailLabel: "Email",
  emailPlaceholder: "Email address",
  emailError: "Enter a valid email address, or report anonymously instead.",
  ...
  technicalContext:
    "Send the page you were on and a few technical details about this device.",
  send: "Send report",
  sending: "Sending…",
  capturing: "Capturing…",
